...
<head>
    ...
    <title>Discrepancy Review | WITMS</title>
    ...
    <div class="row">
        ...
        <div class="col-md-2 px-0 sidebar">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link active" href="<?= base_url('inventory-auditor/discrepancy-review') ?>">
        ...
        <div class="col-md-10 px-0 main-content">
            <div class="topbar d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0"><i class="bi bi-exclamation-triangle text-warning"></i> Discrepancy Review</h5>
                </div>
                <div>
                    <a href="<?= base_url('print/discrepancies') ?>" target="_blank" class="btn btn-outline-secondary btn-sm"><i class="bi bi-printer"></i> Print Report</a>
                </div>
            </div>
