...
<head>
    ...
    <title>Procurement Dashboard | WITMS</title>
    ...
    <div class="row">
        ...
        <div class="col-md-2 px-0 sidebar">
            ...
            <nav class="nav flex-column">
                <a class="nav-link active" href="<?= base_url('procurement/dashboard') ?>">
        ...
        <div class="col-md-10 px-0 main-content">
            <div class="topbar d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0"><i class="bi bi-speedometer2 text-primary"></i> Procurement Dashboard</h5>
                </div>
                <div>
