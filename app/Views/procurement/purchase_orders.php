...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 sidebar">
            ...
            <a href="<?= base_url('procurement/purchase-orders') ?>" class="active">📋 Purchase Orders</a>
        ...
        <div class="col-md-10 p-0">
            <div class="topbar">
                ...
                <div>
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#createPOModal">+ New Purchase Order</button>
                    <a href="<?= base_url('print/purchase-orders') ?>" target="_blank" class="btn btn-outline-secondary btn-sm">🖨️ Print</a>
                </div>
            </div>
