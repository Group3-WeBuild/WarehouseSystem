...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 sidebar">
            ...
            <a href="<?= base_url('procurement/delivery-tracking') ?>">🚚 Delivery Tracking</a>
            <a href="<?= base_url('procurement/vendors') ?>">🏢 Vendors</a>
            <a href="<?= base_url('procurement/reports') ?>" class="active">📈 Reports</a>
        ...
        <div class="col-md-10 p-0">
            <div class="topbar">
                <div>
                    ...
                    <span class="fw-bold">📈 Procurement Reports</span>
                </div>
