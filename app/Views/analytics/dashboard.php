...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 sidebar">
            ...
            <a href="<?= base_url('analytics/dashboard') ?>" class="active">
                <i class="bi bi-speedometer2"></i> Dashboard
            </a>
            <a href="<?= base_url('analytics/forecasting') ?>">
                <i class="bi bi-graph-up"></i> Demand Forecasting
            </a>
            <a href="<?= base_url('analytics/inventory-kpis') ?>">
                <i class="bi bi-box-seam"></i> Inventory KPIs
            </a>
            <a href="<?= base_url('analytics/warehouse-performance') ?>">
                <i class="bi bi-building"></i> Warehouse Performance
            </a>
            <a href="<?= base_url('analytics/financial-kpis') ?>">
                <i class="bi bi-currency-dollar"></i> Financial KPIs
            </a>
            <a href="<?= base_url('analytics/trends') ?>">
                <i class="bi bi-bar-chart-line"></i> Trend Analysis
            </a>
            <a href="<?= base_url('analytics/reorder-recommendations') ?>">
                <i class="bi bi-cart-check"></i> Reorder Recommendations
            </a>
