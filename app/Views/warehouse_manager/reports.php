...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 sidebar">
            ...
            <a href="<?= base_url('warehouse-manager/reports') ?>" class="active"><i class="bi bi-file-earmark-text"></i> Reports</a>
        ...
        <div class="col-md-10 p-0">
            <div class="topbar">
                <div>
                    ...
                    <span class="fw-bold"><i class="bi bi-file-earmark-text"></i> Warehouse Reports</span>
                </div>
