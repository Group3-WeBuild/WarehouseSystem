...
<head>
  ...
  <title>Top Management Dashboard | WeBuild</title>
  ...
  <div class="row">
    ...
    <div class="col-md-2 px-0 sidebar">
      ...
      <nav class="nav flex-column">
        <a class="nav-link active" href="<?= base_url('management/dashboard') ?>"><i class="bi bi-speedometer2"></i> Dashboard</a>
    ...
    <div class="col-md-10 p-0">
      ...
      <div class="page-container">
        <h5><strong>Top Management Dashboard</strong></h5>
        <p class="text-muted mb-4">Monitor and manage WeBuild's financial performance, inventory, and strategic operations</p>
        ...
        <div class="mb-4 d-flex flex-wrap gap-2">
          <button class="btn btn-primary btn-sm">View Financial Report</button>
          <button class="btn btn-outline-secondary btn-sm">Warehouse Status</button>
          <button class="btn btn-outline-secondary btn-sm">Revenue Analysis</button>
          <button class="btn btn-outline-secondary btn-sm">Audit Trail</button>
        </div>

        <!-- Recent Financial Activities Table -->
        <div>
          <h6><strong>Recent Financial Activities</strong></h6>
